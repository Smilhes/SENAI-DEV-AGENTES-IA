    ...
    try:
        ...
        while True:
            ...
            response = openai_client.responses.create(
                ...
                instructions="""
                Você é um assistente de viagens que fornece informações sobre os serviços de viagem disponíveis na Margie's Travel. Responda a perguntas sobre os serviços oferecidos pela Margie's Travel usando os folhetos de viagem fornecidos. Pesquise na web informações gerais sobre destinos ou conselhos de viagem atuais.
                """,
                input=input_text,
